...
public class TaxiCarPoolMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ShowCarpoolList.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(TaxiCarPoolMainActivity.this, TaxiCarPoolShowWatiListActivity.class));
            }
        });
    }
}